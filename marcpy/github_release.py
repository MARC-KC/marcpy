...
def github_release_jsonDF(owner, repo, per_page=3, page = 1):
...
def github_release_versions(owner, repo, tagVersionRegex='', tagPrefixRegex = '', tagSuffixRegex = '', per_page=3, page=1):
